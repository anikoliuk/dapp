...
import ethLogo from '../assets/ethereum-blue-logo-8BC914153E-seeklogo.com.png'
import KNUlogo from '../assets/logo.png'
  ...
  return (
    <div className={style.wrapper}>
      <div className={style.headerLogo}>
        <Image src={KNUlogo} alt='uniswap' height={40} width={40} />
      </div>
